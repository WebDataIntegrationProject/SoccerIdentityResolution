...
public class IR_linear_combination_simple_players
{
    ...
    public static void main( String[] args ) throws Exception
    {
        ...
        // add comparators
        matchingRule.addComparator(new PlayerNameComparatorMongeElkan(true, "doubleMetaphone"), 0.8);
        matchingRule.addComparator(new PlayerBirthDateComparatorExactDateComparison(), 0.2); // F1:0.9194 [P:0.9828, R:0.8636]
