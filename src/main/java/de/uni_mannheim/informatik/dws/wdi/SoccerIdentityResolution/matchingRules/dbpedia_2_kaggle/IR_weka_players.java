...
public class IR_weka_players
{
    ...
    public static void main( String[] args ) throws Exception
    {
        ...
        goldStandardForTraining.loadFromCSVFile(new File("data/goldstandard/gs_dbpedia_2_kaggle_player.csv"));
        ...
        new ErrorAnalysisPlayers().printFalseNegatives(dataDbpedia, dataKaggle, correspondences, goldStandardForTraining);
        ...
        if(WRITE_FEATURE_SET_FOR_EXTERNAL_TOOL) {
            ...
            FeatureVectorDataSet features = learner2.generateTrainingDataForLearning(
                    dataDbpedia, dataKaggle, goldStandardForTraining, matchingRule, null
            );
