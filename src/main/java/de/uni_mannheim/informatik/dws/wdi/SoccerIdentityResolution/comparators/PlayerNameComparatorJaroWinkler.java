...
public class PlayerNameComparatorJaroWinkler implements Comparator<Player, Attribute> {

    private static final long serialVersionUID = 1L;
    private JaroWinklerDistance sim = new JaroWinklerDistance();
    private boolean simplifyString;

    public PlayerNameComparatorJaroWinkler(boolean simplifyString){
        this.simplifyString = simplifyString;
    }

    public PlayerNameComparatorJaroWinkler(){
