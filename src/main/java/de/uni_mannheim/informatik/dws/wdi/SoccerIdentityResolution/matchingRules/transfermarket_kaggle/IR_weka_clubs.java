...
public class IR_weka_clubs
{
    ...
    public static void main( String[] args ) throws Exception
    {
        ...
        // loading data
        HashedDataSet<Club, Attribute> dataTransfermarkt = new HashedDataSet<>();
        new ClubXMLReader().loadFromXML(new File("data/input/transfermarket.xml"), "/clubs/club", dataTransfermarkt);
        ...
        matchingRule.addComparator(new ClubPlayerFullComparator("data/correspondences/kaggle_2_transfermarket_correspondences_players.csv", false)); 

        // F1:0.9032 [P:0.8759, R: 0.9333]
        ...
        goldStandardForTraining.loadFromCSVFile(new File("data/goldstandard/completeGoldstandard/gs_kaggle_2_transfermarkt_WEKA_training_clubs.csv"));
        ...
        new CSVCorrespondenceFormatter().writeCSV(new File("data/output/dbpedia_2_kaggle_correspondences_WEKA_clubs.csv"), correspondences);
        ...
        goldStandardForEvaluation.loadFromCSVFile(new File("data/goldstandard/completeGoldstandard/gs_kaggle_2_transfermarkt_WEKA_test_clubs.csv"));
        ...
        new ErrorAnalysisClubs().printFalseNegatives(dataTransfermarkt, dataKaggle, correspondences, goldStandardForEvaluation);
        ...
        if(WRITE_FEATURE_SET_FOR_EXTERNAL_TOOL) {
            ...
            goldStandardForExternalTool.loadFromCSVFile(new File("data/goldstandard/gs_kaggle_2_transfermarkt_clubs_external_tool.csv"));
            ...
            FeatureVectorDataSet features = learner2.generateTrainingDataForLearning(
                    dataTransfermarkt, dataKaggle, goldStandardForExternalTool, matchingRule, null
            );
